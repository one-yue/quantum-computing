...
class QHHL():
    ...
    def circuit(self):
        ...
        cir += self.G.CX_swap_gate(nl[1], nb[0], na[0])
        ...
        cir += self.G.CX_swap_gate(nl[0], na[0], nb[0])
        cir += self.G.RY_gate(-pi/16, na[0])
        cir += self.G.CX_swap_gate(nl[0], na[0], nb[0])       

        cir += self.G.RY_gate(pi/32, na[0])
        cir += self.G.CX_gate(nl[1] , na[0])
        cir += self.G.RY_gate(-pi/32, na[0])
        cir += self.G.CX_gate(nl[1] , na[0]) 
        ...
        cir += self.G.measure_gate(nl[0])
        cir += self.G.measure_gate(nl[1])	
    ...
    def solve(self):
        ...
        print("number of 0: ", num0/(num0+num1))
        print("number of 1: ", num1/(num0+num1))
        
        plot_histogram(x, title='Bell-State counts').savefig('out3.png')
